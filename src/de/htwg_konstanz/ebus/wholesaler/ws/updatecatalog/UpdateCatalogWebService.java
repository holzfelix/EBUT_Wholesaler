 ...
 * 
 */
@WebServiceClient(name = "UpdateCatalogWebService", targetNamespace = "http://localhost:8084/EBUT_Wholesaler_Zweite_Instanz/UpdateCatalogWebService", wsdlLocation = "http://localhost:8084/EBUT_Wholesaler_Zweite_Instanz/wsdl/updateCatalogue.wsdl")
    ...
    extends Service
{
    ...
    private final static QName UPDATECATALOGWEBSERVICE_QNAME = new QName("http://localhost:8084/EBUT_Wholesaler_Zweite_Instanz/UpdateCatalogWebService", "UpdateCatalogWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/EBUT_Wholesaler_Zweite_Instanz/wsdl/updateCatalogue.wsdl");
    ...
    public UpdateCatalog getUpdateCatalogPort() {
        return super.getPort(new QName("http://localhost:8084/EBUT_Wholesaler_Zweite_Instanz/UpdateCatalogWebService", "updateCatalogPort"), UpdateCatalog.class);
    }
    ...
    public UpdateCatalog getUpdateCatalogPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost:8084/EBUT_Wholesaler_Zweite_Instanz/UpdateCatalogWebService", "updateCatalogPort"), UpdateCatalog.class, features);
    }
