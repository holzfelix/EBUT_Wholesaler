 ...
 *
 */
@WebServiceClient(name = "UpdateCatalogWebService", targetNamespace = "http://localhost:8084/EBUT_Wholesaler/UpdateCatalogWebService", wsdlLocation = "http://192.168.178.39:8084/EBUT_Wholesaler/UpdateCatalogWebService?wsdl")
public class UpdateCatalogWebService
    ...
    private final static QName UPDATECATALOGWEBSERVICE_QNAME = new QName("http://localhost:8084/EBUT_Wholesaler/UpdateCatalogWebService", "UpdateCatalogWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.178.39:8084/EBUT_Wholesaler/UpdateCatalogWebService?wsdl");
