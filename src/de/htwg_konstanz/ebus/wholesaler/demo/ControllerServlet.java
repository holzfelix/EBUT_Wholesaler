 ...
 * and the BO's (Business Objects) of the framework represents the model.<p>
 *
 ...
 * called action in the corresponding JSP page.<p>
 ...
 * actions have to reference the controller servlet via URL.<p>
 * <b>Example-URL:
